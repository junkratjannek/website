...
export default function Home() {
  ...
  return (
    <div>
      <Header />
      {prefUserDark && (
        <div className="items center flex flex-col bg-light-blue pb-20 pl-10 pr-10 pt-20">
          <div className="flex flex-row items-center gap-x-20 rounded-lg bg-dark-blue p-5">
            <div className="flex flex-col gap-y-2 ">
              <p
                className={twMerge(TextStyles.H1, "h-full w-full items-center")}
              >
